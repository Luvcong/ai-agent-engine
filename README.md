...
### Tool 5: `search_pharmacy_info` - 약국 기본정보 조회
- **API**: 건강보험심사평가원 약국정보서비스 `getParmacyBasisList`
- **기능**: 약국명, 지역, 좌표 반경 기반 약국 기본정보 조회
- **질문 예시**: `"근처 약국 찾아줘"`, `"중랑구 신내동 약국 알려줘"`, `"온누리건강약국 정보 알려줘"`
